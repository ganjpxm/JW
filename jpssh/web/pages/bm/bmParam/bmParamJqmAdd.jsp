...
<div style="margin: 2px 20px;">
  <div data-role="header" data-theme="d">
	<h1><fmt:message key="bmParam.add.title"/></h1>
  </div>
  <div id="content" data-role="content" data-theme="c">
	<form id="bmParamForm" action="<c:url value='/saveBmParam'/>" method="post" data-ajax="false">
      ...
      <input id="paramCd" name="paramCd" class="validate[required]"/>
      <div class="lable"><span class="red">*</span><fmt:message key="bmParam.paramName"/> : </div>
      <input id="paramName" name="paramName" class="validate[required]"/>
      <div class="lable"><span class="red">*</span><fmt:message key="bmParam.paramTypeCd"/> : </div>
      <input id="paramTypeCd" name="paramTypeCd" class="validate[required]" value="${paramTypeCd}"/>
      <div class="lable"><span class="red">*</span><fmt:message key="bmParam.paramTypeName"/> : </div>
      <input id="paramTypeName" name="paramTypeName" class="validate[required]" value="${paramTypeName}"/>
