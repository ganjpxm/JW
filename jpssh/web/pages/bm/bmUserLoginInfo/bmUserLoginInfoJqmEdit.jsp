...
<div data-role="dialog">
  <div id="header" data-role="header" data-theme="d">
	<h1><fmt:message key="bmUserLoginInfo.edit.title"/></h1>
  </div>
  <div id="content" data-role="content" data-theme="c">
	<form id="bmUserLoginInfoForm" action="<c:url value='/updateBmUserLoginInfo'/>" method="post" data-ajax="false">
	  <input type="hidden" name="userLoginInfoId" value="${bmUserLoginInfo.userLoginInfoId}"/>
      ...
      <input id="fieldName1" name="fieldName1" class="validate[required]" value="${bmUserLoginInfo.fieldName1}" class="validate[required]"/>
