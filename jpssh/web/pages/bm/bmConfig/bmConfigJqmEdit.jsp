...
<div style="margin: 2px 20px;">
  <div id="header" data-role="header" data-theme="d">
	<h1><fmt:message key="bmConfig.edit.title"/></h1>
  </div>
  <div id="content" data-role="content" data-theme="c">
	<form id="bmConfigForm" action="<c:url value='/updateBmConfig'/>" method="post" data-ajax="false">
	  <input type="hidden" name="configId" value="${bmConfig.configId}"/>
      ...
      <input id="configCd" name="configCd" class="validate[required]" value="${bmConfig.configCd}"/>
      <div class="jqm-form-lable"><fmt:message key="bmConfig.configName"/> : </div>
      <input id="configName" name="configName" class="validate[required]" value="${bmConfig.configName}"/>
      <div class="jqm-form-lable"><fmt:message key="bmConfig.configValue"/> : </div>
      <input id="configValue" name="configValue" class="validate[required]" value="${bmConfig.configValue}"/>
      <div class="jqm-form-lable"><fmt:message key="common.field.description"/> : </div>
      <textarea id="description" name="description" rows="10" cols="30">${bmConfig.description}</textarea>
