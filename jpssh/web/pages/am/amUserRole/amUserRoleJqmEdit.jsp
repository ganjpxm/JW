...
<div data-role="dialog">
  <div id="header" data-role="header" data-theme="d">
	<h1><fmt:message key="amUserRole.edit.title"/></h1>
  </div>
  <div id="content" data-role="content" data-theme="c">
	<form id="amUserRoleForm" action="<c:url value='/updateAmUserRole'/>" method="post" data-ajax="false">
	  <input type="hidden" name="userRoleId" value="${amUserRole.userRoleId}"/>
      ...
      <input id="fieldName1" name="fieldName1" class="validate[required]" value="${amUserRole.fieldName1}" class="validate[required]"/>
