...
<div data-role="dialog">
  <div id="header" data-role="header" data-theme="d">
	<h1><fmt:message key="amUserDetail.edit.title"/></h1>
  </div>
  <div id="content" data-role="content" data-theme="c">
	<form id="amUserDetailForm" action="<c:url value='/updateAmUserDetail'/>" method="post" data-ajax="false">
	  <input type="hidden" name="userDetailId" value="${amUserDetail.userDetailId}"/>
      ...
      <input id="fieldName1" name="fieldName1" class="validate[required]" value="${amUserDetail.fieldName1}" class="validate[required]"/>
