...
<div style="margin: 2px 20px;">
  <div id="header" data-role="header" data-theme="d">
	<h1><fmt:message key="amRole.add.title"/></h1>
  </div>
  <div id="content" data-role="content" data-theme="c">
	<form id="amRoleForm" action="<c:url value='/saveAmRole'/>" method="post" data-ajax="false">
      ...
      <input id="roleCd" name="roleCd" class="validate[required]"/>
      <div class="lable"><span class="red">*</span><fmt:message key="amRole.roleName"/> : </div>
      <input id="roleName" name="roleName" class="validate[required]"/>
