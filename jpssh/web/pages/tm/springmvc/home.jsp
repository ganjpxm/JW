...
<head>
	...
	<link href="<c:url value="/resources/demo/springmvc/form.css" />" rel="stylesheet"  type="text/css" />		
	<link href="<c:url value="/resources/demo/springmvc/jqueryui/1.8/themes/base/jquery.ui.all.css" />" rel="stylesheet" type="text/css"/>
</head>
<body>
...
<div id="tabs">
	<ul>
		...
		<li><a href="<c:url value="/tm/springmvc/form" />" title="forms">Forms</a></li>
		<li><a href="<c:url value="/tm/springmvc/fileupload" />" title="fileupload">File Upload</a></li>
	...
	<div id="data">
		...
		<ul>
			...
			<li>
				...
				<a id="matrixVar" class="textLink" href="<c:url value="/data/matrixvars;foo=bar,hotel;year=2012/simple" />">Matrix variable</a>
			</li>
			<li>
...
<script type="text/javascript" src="<c:url value="/resources/demo/springmvc/jquery/1.6/jquery.js" />"></script>
<script type="text/javascript" src="<c:url value="/resources/demo/springmvc/jqueryform/2.8/jquery.form.js" />"></script>
<script type="text/javascript" src="<c:url value="/resources/demo/springmvc/jqueryui/1.8/jquery.ui.core.js" />"></script>
<script type="text/javascript" src="<c:url value="/resources/demo/springmvc/jqueryui/1.8/jquery.ui.widget.js" />"></script>
<script type="text/javascript" src="<c:url value="/resources/demo/springmvc/jqueryui/1.8/jquery.ui.tabs.js" />"></script>
<script type="text/javascript" src="<c:url value="/resources/demo/springmvc/json2.js" />"></script>
<script>
	MvcUtil = {};
