...
<div data-role="dialog">
  <div id="header" data-role="header" data-theme="d">
	<h1><fmt:message key="cmPhoto.edit.title"/></h1>
  </div>
  <div id="content" data-role="content" data-theme="c">
	...
	<form id="cmPhotoForm" action="<c:url value='/updateCmPhoto'/>" method="post" data-ajax="false">
	  <input type="hidden" name="photoId" value="${cmPhoto.photoId}"/>
	  <input type="hidden" name="menuId" value="${menuId}"/>
	  <input type="hidden" name="categoryId" value="${categoryId}"/>
	  <input type="hidden" id="newCategoryIds" name="newCategoryIds"/>
	  <input type="hidden" id="roleIds" name="roleIds" value="${cmPhoto.roleIds}"/>
      ...
      <input id="title" name="title" value="${cmPhoto.title}"/>
      <div class="lable"><fmt:message key="cmPhoto.tag"/> : </div>
      <input id="tag" name="tag" value="${cmPhoto.tag}"/>
      <!--  
      ...
      <!-- 
      <div class="lable"><fmt:message key="cmPhoto.title"/> URL : 
      <input id="thumbUrl" name="thumbUrl" value="${cmPhoto.thumbUrl}"/>
      ...
      <input id="displayNo" name="displayNo" value="${cmPhoto.displayNo}"/>
      <div class="lable"><fmt:message key="common.field.remark"/> : </div>
      <textarea id="remark" name="remark" cols="40" rows="20" style="height:200px;" class="tinymce validate[required]">${cmPhoto.remark}</textarea>
      <div class="lable"><fmt:message key="cmArticle.articleId"/> : </div>
      <input id="refArticleId" name="refArticleId" value="${cmPhoto.refArticleId}"/>
