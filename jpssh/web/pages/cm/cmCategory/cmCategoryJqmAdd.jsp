...
<div style="margin: 2px 20px;">
  <div id="header" data-role="header" data-theme="d">
	<h1><fmt:message key="cmCategory.add.title"/></h1>
  </div>
  <div id="content" data-role="content" data-theme="c">
	<form id="cmCategoryForm" action="<c:url value='/saveCmCategory'/>" method="post" data-ajax="false">
	  <input type="hidden" name="menuId" value="${menuId}"/>
	  <input type="hidden" name="categoryPid" value="${categoryPid}"/>
	  
	  <!--categoryId,categoryCd,categoryPid,categoryName,endFlag,displayNo,lang,operatorId,operatorName,createDateTime,modifyTimestamp,dataState,-->
	  <div class="lable"><span class="red">*</span><fmt:message key="cmCategory.categoryCd"/> : </div>
      <input id="categoryCd" name="categoryCd" class="validate[required]" value="${categoryCd}"/>
      <div class="lable"><span class="red">*</span><fmt:message key="cmCategory.categoryName"/> : </div>
      <input id="categoryName" name="categoryName" class="validate[required]"/>
      <div class="lable"><span class="red">*</span><fmt:message key="common.field.displayNo"/> : </div>
      <input id="displayNo" name="displayNo" class="validate[required]"/>
