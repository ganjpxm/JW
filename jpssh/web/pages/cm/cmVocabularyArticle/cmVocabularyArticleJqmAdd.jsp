...
<div data-role="dialog">
  <div id="header" data-role="header" data-theme="d">
	<h1><fmt:message key="cmVocabularyArticle.add.title"/></h1>
  </div>
  <div id="content" data-role="content" data-theme="c">
	<form id="cmVocabularyArticleForm" action="<c:url value='/saveCmVocabularyArticle'/>" method="post" data-ajax="false">
