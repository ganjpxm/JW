...
<div data-role="dialog">
  <div id="header" data-role="header" data-theme="d">
	<h1><fmt:message key="cmVocabularyCategory.add.title"/></h1>
  </div>
  <div id="content" data-role="content" data-theme="c">
	<form id="cmVocabularyCategoryForm" action="<c:url value='/saveCmVocabularyCategory'/>" method="post" data-ajax="false">
