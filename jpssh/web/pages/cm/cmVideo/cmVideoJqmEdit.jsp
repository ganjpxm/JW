...
<div style="margin: 2px 20px;">
  <div id="header" data-role="header" data-theme="d">
	<h1><fmt:message key="cmVideo.edit.title"/></h1>
  </div>
  <div id="content" data-role="content" data-theme="c">
	...
	<form id="cmVideoForm" action="<c:url value='/updateCmVideo'/>" method="post" data-ajax="false">
	  <input type="hidden" name="videoId" value="${cmVideo.videoId}"/>
	  <input type="hidden" name="menuId" value="${menuId}"/>
	  <input type="hidden" name="categoryId" value="${categoryId}"/>
	  <input type="hidden" id="newCategoryIds" name="newCategoryIds"/>
	  <input type="hidden" id="roleIds" name="roleIds" value="${cmVideo.roleIds}"/>
      ...
      <input id="title" name="title" value="${cmVideo.title}"/>
      <div class="lable"><fmt:message key="common.field.tag"/> : </div>
      <input id="tag" name="tag" value="${cmVideo.tag}"/>
      <!--  
      <div class="lable"><fmt:message key="common.field.thumbUrl"/> : 
      <input id="thumbUrl" name="thumbUrl" value="${cmVideo.thumbUrl}"/>
      ...
      <a href="javascript:confirmDeleteThumbVideo();" data-role="button" 
		    ...
		    -->
	  <input id="originWebsite" name="originWebsite" value="${cmVideo.originWebsite}"/>
      ...
      <input id="videoUrl" name="url" value="${cmVideo.url}"/>
      <!-- 
      ...
      <input id="displayNo" name="displayNo" value="${cmVideo.displayNo}"/>
