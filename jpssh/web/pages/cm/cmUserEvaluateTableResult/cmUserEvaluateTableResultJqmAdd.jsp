...
<div data-role="dialog">
  <div id="header" data-role="header" data-theme="d">
	<h1><fmt:message key="cmUserEvaluateTableResult.add.title"/></h1>
  </div>
  <div id="content" data-role="content" data-theme="c">
	<form id="cmUserEvaluateTableResultForm" action="<c:url value='/saveCmUserEvaluateTableResult'/>" method="post" data-ajax="false">
